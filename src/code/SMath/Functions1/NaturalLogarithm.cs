...
/// </summary>
/// <remarks>
/// It is a special case of the logarithm function with the base equal to Euler's number.
/// The function is defined for positive numbers only.
/// <a href="https://en.wikipedia.org/wiki/Natural_logarithm">Wikipedia</a>
/// </remarks>
public class NaturalLogarithm : IMathFunction, ISingleDomain, ISingleImage
{
    /// <inheritdoc />
