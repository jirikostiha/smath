...
namespace SMath
{
    ...
    public static class PT
    {
        ...
        /// <summary> Calculates length of hypotenuse of right-angled triangle like object. </summary>
        //public static N Hypotenuse<N>(N[] legs)
        //    where N : IFloatingPoint<N>, IRootFunctions<N>
        //    => N.Sqrt(legs.Sum(x => x * x)));
        
        //Kosinová věta - zobecnění pythagorovy vety na jiné než pravé úhly
        public static N Cosine<N>(N a1, N a2, N angle)
            where N : IFloatingPoint<N>, IRootFunctions<N>, ITrigonometricFunctions<N>
